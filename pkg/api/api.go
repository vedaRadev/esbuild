...
type JSXFactoryMode uint8

const (
  JSXFactoryModeSingle JSXFactoryMode = iota
  JSXFactoryModeDual
)
...
type BuildOptions struct {
  ...
  JSXFactoryMode      JSXFactoryMode  // Documentation: https://esbuild.github.io/api/#jsx-factory-mode
